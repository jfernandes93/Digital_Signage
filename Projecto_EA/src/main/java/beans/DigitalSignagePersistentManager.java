...
@Scope("prototype")
public class DigitalSignagePersistentManager extends PersistentManager {
	...
	private DigitalSignagePersistentManager() throws PersistentException {
	...
	public static synchronized final DigitalSignagePersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new DigitalSignagePersistentManager();
		}
		
		return (DigitalSignagePersistentManager) _instance;
	}
