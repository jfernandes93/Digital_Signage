...
public class PlayerDAO {
	...
	public static Player loadPlayerByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (Player) session.load(implementacao.Player.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Player getPlayerByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (Player) session.get(implementacao.Player.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Player loadPlayerByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Player) session.load(implementacao.Player.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Player getPlayerByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Player) session.get(implementacao.Player.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static List queryPlayer(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From implementacao.Player as Player");
		if (condition != null)
	...
	public static Player createPlayer() {
		return new implementacao.Player();
	}
	
	public static boolean save(implementacao.Player player) throws PersistentException {
		try {
			implementacao.DigitalSignagePersistentManager.instance().saveObject(player);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(implementacao.Player player) throws PersistentException {
		try {
			implementacao.DigitalSignagePersistentManager.instance().deleteObject(player);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean deleteAndDissociate(implementacao.Player player)throws PersistentException {
		try {
			if (player.get_canal() != null) {
				player.get_canal().set_player(null);
			}
			
			if (player.get_rede() != null) {
				player.get_rede()._player.remove(player);
			}
			
			if (player.get_coordenada() != null) {
				player.get_coordenada().set_player(null);
			}
	...
	public static boolean deleteAndDissociate(implementacao.Player player, org.orm.PersistentSession session)throws PersistentException {
		try {
			if (player.get_canal() != null) {
				player.get_canal().set_player(null);
			}
	...
	public static boolean refresh(implementacao.Player player) throws PersistentException {
		try {
			implementacao.DigitalSignagePersistentManager.instance().getSession().refresh(player);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(implementacao.Player player) throws PersistentException {
		try {
			implementacao.DigitalSignagePersistentManager.instance().getSession().evict(player);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static Player loadPlayerByCriteria(PlayerCriteria playerCriteria) {
		Player[] players = listPlayerByCriteria(playerCriteria);
		if(players == null || players.length == 0) {
			return null;
		}
		return players[0];
	...
	public static Player[] listPlayerByCriteria(PlayerCriteria playerCriteria) {
		return playerCriteria.listPlayer();
	}
}
